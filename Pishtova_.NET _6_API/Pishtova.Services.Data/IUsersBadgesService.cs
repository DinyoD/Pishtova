namespace Pishtova.Services.Data
{
    ...
    public interface IUsersBadgesService
    {
        ...
        /// <returns>A task witch result contains OperationResult object with Data property - primary key(Id) value of the newly created userBadge.</returns>
        ...
        /// <returns>A task witch result contains OperationResult object with Data property - collection of entities(UserBadges) with the given userId. If no entity is found, then
        ...
        /// <returns>A task witch result contains OperationResult object with Data property - collection of entities(UserBadges) with the given testId. If no entity is found, then
        ///     Data is empty collection.</returns>
